# Fetech v0.4.0a0 release candidate dependency-license report
...
`0.4.0a0`; the overlay label does not relabel the Python distribution.
...
- Package version: `0.4.0a0`
- `uv.lock` SHA-256: `51ef2dbe3fd8c8c614172e6d5e22b91985b69e42719f74b2f15498829ccdec60`
...
| Input | SHA-256 |
|---|---|
| `scripts/release_v04_candidate.toml` | `4e292edb0037bf427b586a5843b80af4dd666a939d662f0d9fdbfa16ed14c740` |
...
| `CONTRIBUTING.md` | `d17161abb9c80b5c0518c54e41c842b23f6c0269b0269edef9e70ef20495195c` |
...
| `.github/workflows/ci.yml` | `edfd15caa425154bcce131a3c3907f2bafce4fc595f1cd043f14fa94d2c03b08` |
| `.github/workflows/release.yml` | `3ce73cd18efd89dcf0064e21ddd5fb5ed268be7f41c2d750127380840392840d` |
| `deploy/systemd/fetech.service.example` | `bb3b2e50395fb1569cb6b506d3b1374adbfb6fd2fd9672ce0c0ed533ee8f396b` |
...
| `docs/deployment-containment.md` | `03407ccabdf9c041b76c3cb54b0c455efe7b98491761c7945fadb6a1ec82540c` |
| `docs/release-process.md` | `8b573f0d08e7f1d88535b34c17d9ad9bf71d99646255fb347ac83adac554bd48` |
| `docs/security-threat-model.md` | `e7d943593e2601233726049e4f1224667ffe2eb33c2163e867ecf3e957cebfbe` |
| `docs/v0.4-conformance.md` | `2aa2ac6871cef746c9f23628bc2964d6fd058caafa180ea9ad5605760a84de8c` |
| `docs/releases/v0.4.0a0.md` | `5066737357a458c97ac96dc133e69f6dc2730e32cc70bf532cb0648e6e9d2f4d` |
| `scripts/generate_release_evidence.py` | `13efee887298c94e4ece0cc317fc189bbaa02847b0c7296075b7fa98eb8fb9db` |
| `scripts/check_v04_release_readiness.py` | `4bba5e30b5077ac432201eef93cb827f4c002690436ace8179a1968518cf8c15` |
| `scripts/collect_v04_systemd_attestation.py` | `fbb04239217e648791e314475d22a8a924c70e8280ed1ed8215e142d8a0dbeb0` |
| `scripts/release_attestation_common.py` | `0341d9ca14f26fe850e60eb968318e73c501913824b96600d4f5a972dfcbcebb` |
| `scripts/verify_v04_ci_attestation.py` | `c93706d4ff8071d5f64fcb6de7b29e2601bdbcb7254c720ec3f22fdcfec67334` |
| `scripts/verify_v04_github_release.py` | `7f0b63e17221627a9fbd4869ba8be246073d0152f8175e8cbe039e05d08656bf` |
| `scripts/verify_v04_legal_approval.py` | `1bf2ab333f122cb334422cfc52710b01749497a4e59ad6b016a7dc44d2293470` |
| `scripts/verify_v04_pypi_publication.py` | `71aeb0efd38936c083f79bbb2465bb438b14098fc7fcdb24d4be5bc792b7d2ed` |
...
| `scripts/verify_v04_systemd_attestation.py` | `007dc5e2f3c5b82c39b05666d10a1c78919af9d72b59dce102c788adf76c6e67` |
...
| `src/fetech/adapters/reader.py` | `bb366cb500d66c3c5aa754ddc1b55788c327877d636c866d02686a97a18956ac` |
...
| `src/fetech/version.py` | `cf66a10ffc3fd460cddd2fa70fff48e8962f2d0628a1f925aa9e49e1f3320947` |
...
| `tests/test_release_evidence.py` | `921b262fc09c6ba8c9f84af05466b238035d9d49a9f68017b1a6083120e455d3` |
| `tests/test_release_readiness.py` | `d1a8e5c799caceeaaf0cdea8d47fb3af48125fcd2fcb4d25e89fdcbb4ae75945` |
...
| `tests/test_v04_external_release_gates.py` | `a82eeb9acf8216ab266b93772fec5d69546a72093733829d35927fbebf2d0525` |
...
| `tests/test_systemd_unit.py` | `df0a97eccd2f7381638036926a529659e158e899b579415f966171018d247880` |
...
packages distributed in the current `0.4.0a0` wheel, so they are excluded from
...
- Package metadata and candidate notes identify `0.4.0a0`, but the clean release-commit wheel, source distribution, checksum set, tag, GitHub Release, and package publication do not yet exist.
- Focused installed Docling 2.113 source-tree and development-wheel contract/content subsets pass against the exact reference bundle; the final clean v0.4.0a0 candidate wheel still needs complete retained artifact-bound smoke evidence from the release environment.
...
- The exact-version catalog covers all 167 third-party identities in the current universal lock and the v0.4.0a0 candidate reports regenerate; published v0.3 evidence remains immutable and profile-verified. Artifact-level notice and redistribution legal review remains required for the explicit NVIDIA proprietary/EULA and pypdfium2 mixed-distribution LicenseRefs before publication can be approved.
...
```console
uv run python scripts/generate_release_evidence.py --overlay-profile scripts/release_v04_candidate.toml --check
```
